...
class MissionDefeatBSequence extends StatefulWidget {
  final VoidCallback onComplete;

  const MissionDefeatBSequence({
    super.key,
    required this.onComplete,
  });

  @override
  State<MissionDefeatBSequence> createState() => _MissionDefeatBSequenceState();
}

class _MissionDefeatBSequenceState extends State<MissionDefeatBSequence>
  ...
  final List<Map<String, String>> _pages = [
    {
      'image': 'assets/images_histoire/combat2/combat2vaincu.png',
      'text': "Suis-je faible ? ...... Je dois m'entrainer d'avantages !!",
    },
  ];
