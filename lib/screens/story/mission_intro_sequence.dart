...
class MissionIntroSequence extends StatefulWidget {
  final VoidCallback onComplete;

  const MissionIntroSequence({
    super.key,
    required this.onComplete,
  });

  @override
  State<MissionIntroSequence> createState() => _MissionIntroSequenceState();
}

class _MissionIntroSequenceState extends State<MissionIntroSequence>
