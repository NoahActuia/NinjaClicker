...
class MissionVictorySequence extends StatefulWidget {
  final VoidCallback onComplete;

  const MissionVictorySequence({
    super.key,
    required this.onComplete,
  });

  @override
  State<MissionVictorySequence> createState() => _MissionVictorySequenceState();
}

class _MissionVictorySequenceState extends State<MissionVictorySequence>
  ...
  final List<Map<String, String>> _pages = [
    {
      'image': 'assets/images_histoire/combat1/combat1fin.png',
      'text': 'Mon cœur bat vite.\nMais j\'ai tenu bon.',
    },
    {
      'image': 'assets/images_histoire/combat1/combat11fin.png',
